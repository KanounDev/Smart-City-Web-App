    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/issues/approved/public").permitAll()
                        .requestMatchers("/api/issues/*/photos/**").permitAll()
                        .requestMatchers("/api/issues/my").hasAnyAuthority("CITIZEN", "OWNER")
                        .requestMatchers("/api/issues/pending", "/api/issues/admin/**").hasAuthority("ADMIN")
                        .requestMatchers("/api/issues").hasAnyAuthority("CITIZEN", "OWNER", "ADMIN")
